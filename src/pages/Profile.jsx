...
import CallManager from "./CallManager"; // call logic handled here
import "./Profile.css";
...
export default function Profile() {
  ...
  return (
    <div className="profile-container">
          ...
          <>
            <div className="chat-header d-flex align-items-center justify-content-between px-2 py-1">
              ...
              <div
                ...
                title="Call User"
                onClick={() => callManagerRef.current?.handleCallDirect()}
              >
      ...
      {/* CALL MANAGER */}
      <CallManager ref={callManagerRef} me={me} activeUser={activeUser} />
    </div>
  );
}
